...
const LoadDataViaApi = (props) => {
  ...
  return (
    <Layout>
      ...
      <a
        target="_blank"
        href="https://github.com/alexey-dc/nextjs_express_template/blob/main/pages/load_data_via_api.jsx"
      >
        {" "}
        See page source{" "}
      </a>
      ...
      <p>
        This is a common and useful pattern in modern applications, especially
        for Single Page Applications.
      </p>
      <p>
        It is also more complex. The aim of this project is to allow for simpler
        patterns that allow more efficient prototyping. See{" "}
        <a href="/preload_data">this example</a> for an alternative that is
        possible with this NextJS+Express combo setup.
      </p>
      <div className="f-row">
